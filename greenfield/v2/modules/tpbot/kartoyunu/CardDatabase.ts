...
/*******************************************************************72*/
export const CardDatabase: {[key in CardTitle]: Card} =
{
    // tslint:disable: no-string-literal
    [CardTitle["Efsanevi Atatürk"]]: new Card(CardTitle["Efsanevi Atatürk"],
        CardRarity.Destansı,
    ...
    [CardTitle["Şakasına gülünmeyen adam"]]: new Card(CardTitle["Şakasına gülünmeyen adam"],
    ...
    [CardTitle["Muzlu Ajdar"]]: new Card(CardTitle["Muzlu Ajdar"],
        CardRarity.Güzide,
    ...
    [CardTitle["Koca isteyen kari"]]: new Card(CardTitle["Koca isteyen kari"],
        CardRarity.Güzide,
    ...
    [CardTitle["KorkusuzBöyle"]]: new Card(CardTitle["KorkusuzBöyle"],
    ...
    [CardTitle["Kara Murat benim"]]: new Card(CardTitle["Kara Murat benim"],
        CardRarity.Esrarengiz,
    ...
    [CardTitle["Yossi Kohen"]]: new Card(CardTitle["Yossi Kohen"],
        CardRarity.İhtişamlı,
    ...
    [CardTitle["Usta Rakun"]]: new Card(CardTitle["Usta Rakun"],
        CardRarity.Yaygın,
    ...
    [CardTitle["Zikir halkası"]]: new Card(CardTitle["Zikir halkası"],
        CardRarity.Esrarengiz,
    ...
    [CardTitle["Erotik Ajdar"]]: new Card(CardTitle["Erotik Ajdar"],
        CardRarity.İhtişamlı,
    ...
    [CardTitle["Yengec Risitas"]]: new Card(CardTitle["Yengec Risitas"],
        CardRarity.İhtişamlı,
    ...
    [CardTitle["Gözleri kayan Acun"]]: new Card(CardTitle["Gözleri kayan Acun"],
        CardRarity.İhtişamlı,
    ...
    [CardTitle["Halay"]]: new Card(CardTitle["Halay"],
        CardRarity.Güzide,
    ...
    [CardTitle["Tivorlu İsmail"]]: new Card(CardTitle["Tivorlu İsmail"],
        CardRarity.Esrarengiz,
    ...
    [CardTitle["ChangerBöyle"]]: new Card(CardTitle["ChangerBöyle"],
        CardRarity.Destansı,
    ...
    [CardTitle["Tatar Ramazan"]]: new Card(CardTitle["Tatar Ramazan"],
        CardRarity.Esrarengiz,
    ...
    [CardTitle["TP Moderatörlerin gazabı"]]: new Card(CardTitle["TP Moderatörlerin gazabı"],
        CardRarity.Destansı,
    ...
    [CardTitle["Inshallah"]]: new Card(CardTitle["Inshallah"],
        CardRarity.Güzide,
    ...
    [CardTitle["Le Umut Peace"]]: new Card(CardTitle["Le Umut Peace"],
        CardRarity.Esrarengiz,
    ...
    [CardTitle["Kralın Soytarı gifi"]]: new Card(CardTitle["Kralın Soytarı gifi"],
        CardRarity.İhtişamlı,
    ...
    [CardTitle["Küfürbaz Kral"]]: new Card(CardTitle["Küfürbaz Kral"],
        CardRarity.Destansı,
    ...
    [CardTitle["Tempolu Günaydın"]]: new Card(CardTitle["Tempolu Günaydın"],
        CardRarity.Esrarengiz,
    ...
    [CardTitle[":IBOY:"]]: new Card(CardTitle[":IBOY:"],
        CardRarity.Güzide,
    ...
    [CardTitle["HainBöyle"]]: new Card(CardTitle["HainBöyle"],
        CardRarity.Destansı,
    ...
    [CardTitle["İnş cnm ya :)"]]: new Card(CardTitle["İnş cnm ya :)"],
        CardRarity.Güzide,
    ...
    [CardTitle["@everyone"]]: new Card(CardTitle["@everyone"],
        CardRarity.Güzide,
    ...
    [CardTitle["Etiket"]]: new Card(CardTitle["Etiket"],
        CardRarity.Yaygın,
    ...
    [CardTitle["Çifte Bump"]]: new Card(CardTitle["Çifte Bump"],
        CardRarity.İhtişamlı,
    ...
    [CardTitle["Bump!"]]: new Card(CardTitle["Bump!"],
        CardRarity.İhtişamlı,
    ...
    [CardTitle["Ricardo Milos"]]: new Card(CardTitle["Ricardo Milos"],
        CardRarity.Esrarengiz,
